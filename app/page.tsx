        ...
        <section className="min-w-0 px-4 py-5 sm:px-7 sm:py-7 lg:px-10 lg:py-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-8">
            ...
            {isAdmin && <TabsContent value="admin" className="mt-5">
              ...
              {selectedProfile && <div ref={previewRef} className="mt-5"><OperatorPreview title="Перегляд кабінету оператора" profile={selectedProfile} rows={selectedRows} links={selectedLinks} /></div>}
            </TabsContent>}
          </Tabs>
        </section>
      </div>
